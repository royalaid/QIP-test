...
const Debug = () => {
  const envVars = {
    'VITE_QIP_REGISTRY_ADDRESS': import.meta.env.VITE_QIP_REGISTRY_ADDRESS,
    ...
    'config.qipRegistryAddress': config.qipRegistryAddress,
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="mt-4">
        <h2 className="text-xl font-bold mb-2">Query Key for QIPs List:</h2>
        <code className="bg-gray-200 p-2 rounded">
          ['qips', 'list', '{config.qipRegistryAddress || "undefined"}', filters]
        </code>
      </div>
    </div>
  );
