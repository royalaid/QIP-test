    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          ...
          <Link to="/create-proposal" className="block p-6 bg-card rounded-lg shadow-md hover:shadow-lg transition-shadow">
            <h2 className="text-2xl font-semibold mb-2">Create New Proposal</h2>
            <p className="text-muted-foreground">Have an idea to improve QiDAO? Submit a new proposal for community review.</p>
          </Link>
        </div>
